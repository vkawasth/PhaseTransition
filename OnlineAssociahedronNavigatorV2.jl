...
#
# Requires:
#   using JSON3, Statistics, Combinatorics, CairoMakie, LinearAlgebra
#
###############################################################
...
###############################################################
# SCORES (fixed for prime_paths as array)
###############################################################
...
###############################################################
# MONODROMY (fixed for prime_paths as array)
###############################################################

function monodromy(snapshot)

    M = Matrix(I, N, N)   # I now defined via LinearAlgebra
