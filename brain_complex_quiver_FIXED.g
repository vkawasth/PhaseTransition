LoadPackage("qpa");
LoadPackage("homalg");   # sometimes needed
LoadPackage("hap");      # for cohomology
k := GF(101);
Q_vertices := ["CA1sp", "BLA", "HY", "HPF", "sAMY", "LA"];

Q_arrows := [["CA1sp", "HPF", "f_CA1sp_HPF"], ["HPF", "CA1sp", "f_HPF_CA1sp"], ["BLA", "LA", "f_BLA_LA"], ["BLA", "sAMY", "f_BLA_sAMY"], ["CA1sp", "sAMY", "f_CA1sp_sAMY"], ["HPF", "BLA", "f_HPF_BLA"], ["HPF", "sAMY", "f_HPF_sAMY"], ["LA", "BLA", "f_LA_BLA"], ["LA", "sAMY", "f_LA_sAMY"], ["sAMY", "BLA", "f_sAMY_BLA"], ["sAMY", "HPF", "f_sAMY_HPF"], ["sAMY", "LA", "f_sAMY_LA"], ["HY", "sAMY", "f_HY_sAMY"], ["sAMY", "HY", "f_sAMY_HY"], ["CA1sp","BLA","f_CA1sp_BLA"],
  ["CA1sp","HY","f_CA1sp_HY"],
  ["BLA","HY","f_BLA_HY"],
  ["BLA","HPF","f_BLA_HPF"],
  ["HY","BLA","f_HY_BLA"],
...
#Append(rels, List(AllPathsOfLength(A,3), p -> p));
AddNthPowerToRelations(A, rels, 3);

I := Ideal(A, rels);
B := A / I;

#Print("Is the ideal admissible? ", IsAdmissibleIdeal(I), "\n");
#Print("Radical of A: ", RadicalOfAlgebra(A), "\n");
