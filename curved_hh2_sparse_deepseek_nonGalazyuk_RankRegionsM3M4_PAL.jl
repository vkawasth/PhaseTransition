...
# ------------------------------------------------------------
nodes = [:CA1sp, :HPF, :BLA, :sAMY, :HY, :LA, :PAL]   # add :PAL later
...
# python real_node_region_qpa_PAL.py node_regions_clean.csv ../../BALBc_no1_raw/BALBc-no1_iso3um_stitched_segmentation_bulge_size_3.0_edges.csv
...
regions = ["sAMY", "HPF", "BLA", "CA1sp", "HY", "LA", "PAL"]
...
function fast_state_to_scores(state, nodes_df, node_regions)
    ...
    local_region_names = [:sAMY, :HPF, :BLA, :CA1sp, :HY, :LA, :PAL]
...
# ------------------------------------------------------------
region_names = ["sAMY", "HPF", "BLA", "CA1sp", "HY", "LA", "PAL"]
